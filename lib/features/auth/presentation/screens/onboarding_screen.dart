...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
  ...
  Future<void> _save() async {
    ...
    final validationError = validateOnboardingInput(
      year: _year,
      branch: _branch,
    );
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                spacing: 10,
                runSpacing: 10,
                children: (_step == 0 ? _years : _branches).asMap().entries.map(
                  (e) {
              ...
              if (_step == 0 && _year != null) ...[
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'What you\'ll see as a ${_yearLabel(_year!)} year',
                        style: AppText.label,
                      ),
                      const SizedBox(height: 10),
                      ..._previewItems(_year!).map(
                        (item) => Padding(
  ...
  List<String> _previewItems(int year) {
    switch (year) {
      case 1:
        return [
          'Orientation & hostel guides',
          'Basic campus navigation',
          '1st year common Q&A',
        ];
      case 2:
        return [
          'Mid-semester exam guides',
          'Internship prep resources',
          '2nd year Q&A questions',
        ];
      case 3:
        return [
          'Placement readiness guides',
